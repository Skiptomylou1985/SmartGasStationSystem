...
#if defined( _WINDLL)
	#define PLAYM4_API  __declspec(dllexport) 
#else 
...
extern "C" PLAYM4_API BOOL __stdcall  PlayM4_InitDDraw(HWND hWnd);
//Release directDraw; Now invalid.
extern "C" PLAYM4_API BOOL __stdcall PlayM4_RealeseDDraw();
extern "C" PLAYM4_API BOOL __stdcall PlayM4_OpenFile(LONG nPort,LPSTR sFileName);
extern "C" PLAYM4_API BOOL __stdcall PlayM4_CloseFile(LONG nPort);
extern "C" PLAYM4_API BOOL __stdcall PlayM4_Play(LONG nPort, HWND hWnd);
extern "C" PLAYM4_API BOOL __stdcall PlayM4_Stop(LONG nPort);
extern "C" PLAYM4_API BOOL __stdcall PlayM4_Pause(LONG nPort,DWORD nPause);
extern "C" PLAYM4_API BOOL __stdcall PlayM4_Fast(LONG nPort);
extern "C" PLAYM4_API BOOL __stdcall PlayM4_Slow(LONG nPort);
extern "C" PLAYM4_API BOOL __stdcall PlayM4_OneByOne(LONG nPort);
...
extern "C" PLAYM4_API BOOL __stdcall PlayM4_OpenStream(LONG nPort,PBYTE pFileHeadBuf,DWORD nSize,DWORD nBufPoolSize);
extern "C" PLAYM4_API BOOL __stdcall PlayM4_InputData(LONG nPort,PBYTE pBuf,DWORD nSize);
...
//23
////////////////ver 2.0 added///////////////////////////////////////
extern "C" PLAYM4_API BOOL __stdcall	PlayM4_SetDecCallBack(LONG nPort,void (CALLBACK* DecCBFun)(long nPort,char * pBuf,long nSize,FRAME_INFO * pFrameInfo, long nReserved1,long nReserved2));
...
//11
////////////////ver 2.2 added///////////////////////////////////////
extern "C" PLAYM4_API DWORD __stdcall  PlayM4_GetLastError(LONG nPort);
...
extern "C" PLAYM4_API BOOL __stdcall PlayM4_GetPort(LONG* nPort);
